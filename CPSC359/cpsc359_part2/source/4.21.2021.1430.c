...
void checkRowCollision(int xOffFrog, struct drawing* cars);
...
int checkCarCollision(struct allDrawings *picture) {
	...
	switch(frogY) {
		...
		case 648:	if (currentRow != 648) {
					...
					checkRowCollision(frogX, picture -> firstCars.carsRow);
					break;
	}
...
void* drawThread(void * picture) {
		...
		for (a = 0; a < 5; a++) {
			...
			//for the second row of cars
			((struct allDrawings*)picture)->row2cars.carsRow[a].height = 36;
			((struct allDrawings*)picture)->row2cars.carsRow[a].width = 108;		
			((struct allDrawings*)picture)->row2cars.carsRow[a].yOffset = 612;
			...
			//for the fourth row of cars
			((struct allDrawings*)picture)->row4cars.carsRow[a].height = 36;
			((struct allDrawings*)picture)->row4cars.carsRow[a].width = 108;		
			((struct allDrawings*)picture)->row4cars.carsRow[a].yOffset = 540;
			...
			//for the logs in the 7th row
			((struct allDrawings*)picture)->row7logs.carsRow[a].height = 36;
			((struct allDrawings*)picture)->row7logs.carsRow[a].width = 108;		
			((struct allDrawings*)picture)->row7logs.carsRow[a].yOffset = 432;
			...
			//for the logs in the 9th row
			((struct allDrawings*)picture)->row9logs.carsRow[a].height = 36;
			((struct allDrawings*)picture)->row9logs.carsRow[a].width = 108;		
			((struct allDrawings*)picture)->row9logs.carsRow[a].yOffset = 360;
			...
			//for the cars in the 12th row
			((struct allDrawings*)picture)->row12cars.carsRow[a].height = 36;
			((struct allDrawings*)picture)->row12cars.carsRow[a].width = 108;		
			((struct allDrawings*)picture)->row12cars.carsRow[a].yOffset = 252;
			...
			//for the cars in the 14th row
			((struct allDrawings*)picture)->row14cars.carsRow[a].height = 36;
			((struct allDrawings*)picture)->row14cars.carsRow[a].width = 108;		
			((struct allDrawings*)picture)->row14cars.carsRow[a].yOffset = 180;
			...
			//for the logs in the 17th row
			((struct allDrawings*)picture)->row17logs.carsRow[a].height = 36;
			((struct allDrawings*)picture)->row17logs.carsRow[a].width = 108;		
			((struct allDrawings*)picture)->row17logs.carsRow[a].yOffset = 72;
			...
			//for the logs in the 19th row
			((struct allDrawings*)picture)->row19logs.carsRow[a].height = 36;
			((struct allDrawings*)picture)->row19logs.carsRow[a].width = 108;		
			((struct allDrawings*)picture)->row19logs.carsRow[a].yOffset = 0;
		...
		//row 2 of cars
		((struct allDrawings*)picture)->row2cars.carsRow[0].xOffset = -72;
		((struct allDrawings*)picture)->row2cars.carsRow[1].xOffset = -216;
		((struct allDrawings*)picture)->row2cars.carsRow[2].xOffset = -396;
		((struct allDrawings*)picture)->row2cars.carsRow[3].xOffset = -540;
		((struct allDrawings*)picture)->row2cars.carsRow[4].xOffset = -720;
		...
		//row 4 of cars
		((struct allDrawings*)picture)->row4cars.carsRow[0].xOffset = -72;
		((struct allDrawings*)picture)->row4cars.carsRow[1].xOffset = -216;
		((struct allDrawings*)picture)->row4cars.carsRow[2].xOffset = -396;
		((struct allDrawings*)picture)->row4cars.carsRow[3].xOffset = -540;
		((struct allDrawings*)picture)->row4cars.carsRow[4].xOffset = -720;
		...
		//row 7 of logs
		((struct allDrawings*)picture)->row7logs.carsRow[0].xOffset = -72;
		((struct allDrawings*)picture)->row7logs.carsRow[1].xOffset = -216;
		((struct allDrawings*)picture)->row7logs.carsRow[2].xOffset = -396;
		((struct allDrawings*)picture)->row7logs.carsRow[3].xOffset = -540;
		((struct allDrawings*)picture)->row7logs.carsRow[4].xOffset = -720;
		...
		//row 9 of logs
		((struct allDrawings*)picture)->row9logs.carsRow[0].xOffset = -72;
		((struct allDrawings*)picture)->row9logs.carsRow[1].xOffset = -216;
		((struct allDrawings*)picture)->row9logs.carsRow[2].xOffset = -396;
		((struct allDrawings*)picture)->row9logs.carsRow[3].xOffset = -540;
		((struct allDrawings*)picture)->row9logs.carsRow[4].xOffset = -720;
		...
		//row 12 of cars
		((struct allDrawings*)picture)->row12cars.carsRow[0].xOffset = -72;
		((struct allDrawings*)picture)->row12cars.carsRow[1].xOffset = -216;
		((struct allDrawings*)picture)->row12cars.carsRow[2].xOffset = -396;
		((struct allDrawings*)picture)->row12cars.carsRow[3].xOffset = -540;
		((struct allDrawings*)picture)->row12cars.carsRow[4].xOffset = -720;
		...
		//row 14 of cars
		((struct allDrawings*)picture)->row14cars.carsRow[0].xOffset = -72;
		((struct allDrawings*)picture)->row14cars.carsRow[1].xOffset = -216;
		((struct allDrawings*)picture)->row14cars.carsRow[2].xOffset = -396;
		((struct allDrawings*)picture)->row14cars.carsRow[3].xOffset = -540;
		((struct allDrawings*)picture)->row14cars.carsRow[4].xOffset = -720;
		...
		//row 17 of logs
		((struct allDrawings*)picture)->row17logs.carsRow[0].xOffset = -72;
		((struct allDrawings*)picture)->row17logs.carsRow[1].xOffset = -216;
		((struct allDrawings*)picture)->row17logs.carsRow[2].xOffset = -396;
		((struct allDrawings*)picture)->row17logs.carsRow[3].xOffset = -540;
		((struct allDrawings*)picture)->row17logs.carsRow[4].xOffset = -720;
		...
		//row 19 of logs
		((struct allDrawings*)picture)->row19logs.carsRow[0].xOffset = -72;
		((struct allDrawings*)picture)->row19logs.carsRow[1].xOffset = -216;
		((struct allDrawings*)picture)->row19logs.carsRow[2].xOffset = -396;
		((struct allDrawings*)picture)->row19logs.carsRow[3].xOffset = -540;
		((struct allDrawings*)picture)->row19logs.carsRow[4].xOffset = -720;
		...
		while (1) {
			...
			for (a = 0; a < 5; a++) {
				...
				//19 row logs
				((struct allDrawings*)picture)->row19logs.carsRow[a].xOffset += 2;
				
				if (((struct allDrawings*)picture)->row19logs.carsRow[a].xOffset <= 756 &&
				((struct allDrawings*)picture)->row19logs.carsRow[a].xOffset > 0) {
					draw(&(((struct allDrawings*)picture)->row19logs.carsRow[a]), log3Ptr);
				}
				
				if (((struct allDrawings*)picture)->row19logs.carsRow[0].xOffset >= 1584) {
					((struct allDrawings*)picture)->row19logs.carsRow[0].xOffset = -72;
				}
				
				if (((struct allDrawings*)picture)->row19logs.carsRow[1].xOffset >= 1404) {
					((struct allDrawings*)picture)->row19logs.carsRow[1].xOffset = -216;
				}
				
				if (((struct allDrawings*)picture)->row19logs.carsRow[2].xOffset >= 1260) {
					((struct allDrawings*)picture)->row19logs.carsRow[2].xOffset = -396;
				}
				
				if (((struct allDrawings*)picture)->row19logs.carsRow[3].xOffset >= 1080) {
					((struct allDrawings*)picture)->row19logs.carsRow[3].xOffset = -540;
				}
				
				if (((struct allDrawings*)picture)->row19logs.carsRow[4].xOffset >= 936) {
					((struct allDrawings*)picture)->row19logs.carsRow[4].xOffset = -720;
				}
				...
				((struct allDrawings*)picture)->row18logs.carsRow[a].xOffset > 0) {
					draw(&(((struct allDrawings*)picture)->row18logs.carsRow[a]), log2Ptr);
				}
				...
				//17 row logs
				((struct allDrawings*)picture)->row17logs.carsRow[a].xOffset += 2;
				
				if (((struct allDrawings*)picture)->row17logs.carsRow[a].xOffset <= 756 &&
				((struct allDrawings*)picture)->row17logs.carsRow[a].xOffset > 0) {
					draw(&(((struct allDrawings*)picture)->row17logs.carsRow[a]), log3Ptr);
				}
				
				if (((struct allDrawings*)picture)->row17logs.carsRow[0].xOffset >= 1584) {
					((struct allDrawings*)picture)->row17logs.carsRow[0].xOffset = -72;
				}
				
				if (((struct allDrawings*)picture)->row17logs.carsRow[1].xOffset >= 1404) {
					((struct allDrawings*)picture)->row17logs.carsRow[1].xOffset = -216;
				}
				
				if (((struct allDrawings*)picture)->row17logs.carsRow[2].xOffset >= 1260) {
					((struct allDrawings*)picture)->row17logs.carsRow[2].xOffset = -396;
				}
				
				if (((struct allDrawings*)picture)->row17logs.carsRow[3].xOffset >= 1080) {
					((struct allDrawings*)picture)->row17logs.carsRow[3].xOffset = -540;
				}
				
				if (((struct allDrawings*)picture)->row17logs.carsRow[4].xOffset >= 936) {
					((struct allDrawings*)picture)->row17logs.carsRow[4].xOffset = -720;
				}
				...
				((struct allDrawings*)picture)->row16logs.carsRow[a].xOffset > 0) {
					draw(&(((struct allDrawings*)picture)->row16logs.carsRow[a]), log2Ptr);
				}
				...
				//row 14 cars
				((struct allDrawings*)picture)->row14cars.carsRow[a].xOffset += 2;
				
				if (((struct allDrawings*)picture)->row14cars.carsRow[a].xOffset <= 756 &&
				((struct allDrawings*)picture)->row14cars.carsRow[a].xOffset > 0) {
					draw(&(((struct allDrawings*)picture)->row14cars.carsRow[a]), car3Ptr);
				}
				
				if (((struct allDrawings*)picture)->row14cars.carsRow[0].xOffset >= 1584) {
					((struct allDrawings*)picture)->row14cars.carsRow[0].xOffset = -72;
				}
				
				if (((struct allDrawings*)picture)->row14cars.carsRow[1].xOffset >= 1404) {
					((struct allDrawings*)picture)->row14cars.carsRow[1].xOffset = -216;
				}
				
				if (((struct allDrawings*)picture)->row14cars.carsRow[2].xOffset >= 1260) {
					((struct allDrawings*)picture)->row14cars.carsRow[2].xOffset = -396;
				}
				
				if (((struct allDrawings*)picture)->row14cars.carsRow[3].xOffset >= 1080) {
					((struct allDrawings*)picture)->row14cars.carsRow[3].xOffset = -540;
				}
				
				if (((struct allDrawings*)picture)->row14cars.carsRow[4].xOffset >= 936) {
					((struct allDrawings*)picture)->row14cars.carsRow[4].xOffset = -720;
				}
				...
				//row 12 cars
				((struct allDrawings*)picture)->row12cars.carsRow[a].xOffset += 2;
				
				if (((struct allDrawings*)picture)->row12cars.carsRow[a].xOffset <= 756 &&
				((struct allDrawings*)picture)->row12cars.carsRow[a].xOffset > 0) {
					draw(&(((struct allDrawings*)picture)->row12cars.carsRow[a]), car3Ptr);
				}
				
				if (((struct allDrawings*)picture)->row12cars.carsRow[0].xOffset >= 1584) {
					((struct allDrawings*)picture)->row12cars.carsRow[0].xOffset = -72;
				}
				
				if (((struct allDrawings*)picture)->row12cars.carsRow[1].xOffset >= 1404) {
					((struct allDrawings*)picture)->row12cars.carsRow[1].xOffset = -216;
				}
				
				if (((struct allDrawings*)picture)->row12cars.carsRow[2].xOffset >= 1260) {
					((struct allDrawings*)picture)->row12cars.carsRow[2].xOffset = -396;
				}
				
				if (((struct allDrawings*)picture)->row12cars.carsRow[3].xOffset >= 1080) {
					((struct allDrawings*)picture)->row12cars.carsRow[3].xOffset = -540;
				}
				
				if (((struct allDrawings*)picture)->row12cars.carsRow[4].xOffset >= 936) {
					((struct allDrawings*)picture)->row12cars.carsRow[4].xOffset = -720;
				}
				...
				//ninth row logs
				((struct allDrawings*)picture)->row9logs.carsRow[a].xOffset += 2;
				
				if (((struct allDrawings*)picture)->row9logs.carsRow[a].xOffset <= 756 &&
				((struct allDrawings*)picture)->row9logs.carsRow[a].xOffset > 0) {
					draw(&(((struct allDrawings*)picture)->row9logs.carsRow[a]), log3Ptr);
				}
				
				if (((struct allDrawings*)picture)->row9logs.carsRow[0].xOffset >= 1584) {
					((struct allDrawings*)picture)->row9logs.carsRow[0].xOffset = -72;
				}
				
				if (((struct allDrawings*)picture)->row9logs.carsRow[1].xOffset >= 1404) {
					((struct allDrawings*)picture)->row9logs.carsRow[1].xOffset = -216;
				}
				
				if (((struct allDrawings*)picture)->row9logs.carsRow[2].xOffset >= 1260) {
					((struct allDrawings*)picture)->row9logs.carsRow[2].xOffset = -396;
				}
				
				if (((struct allDrawings*)picture)->row9logs.carsRow[3].xOffset >= 1080) {
					((struct allDrawings*)picture)->row9logs.carsRow[3].xOffset = -540;
				}
				
				if (((struct allDrawings*)picture)->row9logs.carsRow[4].xOffset >= 936) {
					((struct allDrawings*)picture)->row9logs.carsRow[4].xOffset = -720;
				}
				...
				((struct allDrawings*)picture)->row8logs.carsRow[a].xOffset > 0) {
					draw(&(((struct allDrawings*)picture)->row8logs.carsRow[a]), log2Ptr);
				}
				...
				//seventh row logs
				((struct allDrawings*)picture)->row7logs.carsRow[a].xOffset += 2;
				
				if (((struct allDrawings*)picture)->row7logs.carsRow[a].xOffset <= 756 &&
				((struct allDrawings*)picture)->row7logs.carsRow[a].xOffset > 0) {
					draw(&(((struct allDrawings*)picture)->row7logs.carsRow[a]), log3Ptr);
				}
				
				if (((struct allDrawings*)picture)->row7logs.carsRow[0].xOffset >= 1584) {
					((struct allDrawings*)picture)->row7logs.carsRow[0].xOffset = -72;
				}
				
				if (((struct allDrawings*)picture)->row7logs.carsRow[1].xOffset >= 1404) {
					((struct allDrawings*)picture)->row7logs.carsRow[1].xOffset = -216;
				}
				
				if (((struct allDrawings*)picture)->row7logs.carsRow[2].xOffset >= 1260) {
					((struct allDrawings*)picture)->row7logs.carsRow[2].xOffset = -396;
				}
				
				if (((struct allDrawings*)picture)->row7logs.carsRow[3].xOffset >= 1080) {
					((struct allDrawings*)picture)->row7logs.carsRow[3].xOffset = -540;
				}
				
				if (((struct allDrawings*)picture)->row7logs.carsRow[4].xOffset >= 936) {
					((struct allDrawings*)picture)->row7logs.carsRow[4].xOffset = -720;
				}
				...
				((struct allDrawings*)picture)->row6logs.carsRow[a].xOffset > 0) {
					draw(&(((struct allDrawings*)picture)->row6logs.carsRow[a]), log2Ptr);
				}
				...
				//fourth row
				((struct allDrawings*)picture)->row4cars.carsRow[a].xOffset += 2;
				
				if (((struct allDrawings*)picture)->row4cars.carsRow[a].xOffset <= 756 &&
				((struct allDrawings*)picture)->row4cars.carsRow[a].xOffset > 0) {
					draw(&(((struct allDrawings*)picture)->row4cars.carsRow[a]), car3Ptr);
				}
				
				if (((struct allDrawings*)picture)->row4cars.carsRow[0].xOffset >= 1584) {
					((struct allDrawings*)picture)->row4cars.carsRow[0].xOffset = -72;
				}
				
				if (((struct allDrawings*)picture)->row4cars.carsRow[1].xOffset >= 1404) {
					((struct allDrawings*)picture)->row4cars.carsRow[1].xOffset = -216;
				}
				
				if (((struct allDrawings*)picture)->row4cars.carsRow[2].xOffset >= 1260) {
					((struct allDrawings*)picture)->row4cars.carsRow[2].xOffset = -396;
				}
				
				if (((struct allDrawings*)picture)->row4cars.carsRow[3].xOffset >= 1080) {
					((struct allDrawings*)picture)->row4cars.carsRow[3].xOffset = -540;
				}
				
				if (((struct allDrawings*)picture)->row4cars.carsRow[4].xOffset >= 936) {
					((struct allDrawings*)picture)->row4cars.carsRow[4].xOffset = -720;
				}
				...
				//second row
				((struct allDrawings*)picture)->row2cars.carsRow[a].xOffset += 2;
				
				if (((struct allDrawings*)picture)->row2cars.carsRow[a].xOffset <= 756 &&
				((struct allDrawings*)picture)->row2cars.carsRow[a].xOffset > 0) {
					draw(&(((struct allDrawings*)picture)->row2cars.carsRow[a]), car3Ptr);
				}
				
				if (((struct allDrawings*)picture)->row2cars.carsRow[0].xOffset >= 1584) {
					((struct allDrawings*)picture)->row2cars.carsRow[0].xOffset = -72;
				}
				
				if (((struct allDrawings*)picture)->row2cars.carsRow[1].xOffset >= 1404) {
					((struct allDrawings*)picture)->row2cars.carsRow[1].xOffset = -216;
				}
				
				if (((struct allDrawings*)picture)->row2cars.carsRow[2].xOffset >= 1260) {
					((struct allDrawings*)picture)->row2cars.carsRow[2].xOffset = -396;
				}
				
				if (((struct allDrawings*)picture)->row2cars.carsRow[3].xOffset >= 1080) {
					((struct allDrawings*)picture)->row2cars.carsRow[3].xOffset = -540;
				}
				
				if (((struct allDrawings*)picture)->row2cars.carsRow[4].xOffset >= 936) {
					((struct allDrawings*)picture)->row2cars.carsRow[4].xOffset = -720;
				}
